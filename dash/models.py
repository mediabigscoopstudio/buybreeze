...
class Branch(models.Model):
    ...
    gps_lat      = models.DecimalField(max_digits=600, decimal_places=7, blank=True, null=True)
    gps_lng      = models.DecimalField(max_digits=600, decimal_places=7, blank=True, null=True)
