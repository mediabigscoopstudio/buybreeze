...
class Branch(models.Model):
    ...
    gps_lat      = models.DecimalField(max_digits=18, decimal_places=7, blank=True, null=True)
    gps_lng      = models.DecimalField(max_digits=18, decimal_places=7, blank=True, null=True)
    gps_radius   = models.FloatField(default=100, help_text='Radius in meters for HR punch-in')
